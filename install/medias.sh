...
do
    ...
    cat<<EOF
    ==========================================================
               zer's automated medias installer
    ----------------------------------------------------------
...
EOF
    read -n1 -s
    case "$REPLY" in
    "1")source install/Maraschino.sh;;
    "2")source install/HTPC_Manager.sh;;
    "3")source install/SickRage.sh;;
    "4")source install/uBooquity.sh;;
    "5")source install/CouchPotato.sh;;
    "6")source install/HeadPhones.sh;;
    "0")source install/Maraschino.sh
        source install/HTPC_Manager.sh
